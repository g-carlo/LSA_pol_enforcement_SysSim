function runSimulation_v3_fnc(sim_idx,sim_label,paramStructToChange)
...
mainSim_v3_fnc(conf,carrierArray,cellTypeArray,carrierTypeArray,type2TypeArray,sim_idx,sim_label);
