function result = runSimulation_v3_fnc_MBEHMisProb(sim_idx,sim_label,paramStructToChange)
...
conf = getInputParametersMisProb();
...
result = mainSim_v3_fnc_MBEHMisProb(conf,carrierArray,cellTypeArray,carrierTypeArray,type2TypeArray,sim_idx,sim_label);
