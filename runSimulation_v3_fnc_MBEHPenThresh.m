function result = runSimulation_v3_fnc_MBEHPenThresh(sim_idx,sim_label,paramStructToChange)
...
conf = getInputParametersPenThresh();
...
result = mainSim_v3_fnc_MBEHPenThresh(conf,carrierArray,cellTypeArray,carrierTypeArray,type2TypeArray,sim_idx,sim_label);
