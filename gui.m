...
% Last Modified by GUIDE v2.5 09-May-2018 20:45:36
...
if (get(handles.fig6,'Value') ~= 0) %%if button for fig6 is pressed
    run Simulator6.m;
elseif (get(handles.fig7,'Value') ~= 0)
    run Simulator7vol2.m;
end
