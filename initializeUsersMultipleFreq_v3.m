...
function ues = initializeUsersMultipleFreq_v3(cls,cellTypeArray,genConfig,...
...
%                      0,0,'userPos.txt',0);
             ...
             for ii = 1: ( cellTypeArray(macroInd).numOfCellsPerOperator * deployConfig.numOfUEperCellType( macroInd ))
                 for jj = 1:deployConfig.numOfNetworkOperators   
                     ue_ind = ( cellTypeArray(macroInd).numOfCellsPerOperator * deployConfig.numOfUEperCellType( macroInd ))*(jj-1) + ii;
