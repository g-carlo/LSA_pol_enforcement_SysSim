...
%     end
%   
    [carrierArray, cellsPerCarrier, varPoints] = setCellsPerCarrier(...
        carrierArray, [cls.complexPosition], ...
        conf.general.randomAssigCellsPerCarrier, conf.general.cellRatio);
    ...
    tic;
    ues =initializeUsersMultipleFreq_v2(cls,cellTypeArray,...
...
%     
    ...
    if isEiRP==1
        ...
        varDistCellUeNoWA = generateChannelFnc_v2(cls,ues,conf.antenna,conf.channel,...
            ...
            conf.deployment.numOfSites,conf.deployment.numOfCellsPerSite);
    ...
    for varTTI=1:totTTI
        ...
        for ii=1:numOfCarriers
            ...
            for j = 1:numOfCellsInCarrier
                ...
                cls(n_cell).updateVariables_FSU(objCarrier,objType.macroFSUfeedbackFlag,...
                    varTTI,conf.scheduling,conf.fsu,conf.PHYmodelling,conf.l2s,...
                    objType.reuseScheme,varNumOfMacro, fstPicoInd,lstPicoInd,...
                    picoAllocType);
...
%             
    ...
    objFinalResults.computeFinalResults(ues, cls, conf.PHY.TTIduration,...
        ...
        cellTypeArray,conf.deployment.numOfUEperCellType);
