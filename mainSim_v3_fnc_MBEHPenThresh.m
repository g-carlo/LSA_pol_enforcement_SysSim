function result = mainSim_v3_fnc_MBEHPenThresh(conf,carrierArray,cellTypeArray,carrierTypeArray,type2TypeArray,sim_idx,sim_label)
...
%     end
    ...
    [cellsPerCarrier, opPerLSAchannel] = LSA_controller.runL1_algorithm([cls.complexPosition],[cls.orientation],conf.cellType.height(1),conf.antenna,conf.carrier.cellType.antennaGain(:,1).',[carrierArray.electricalDowntilt],conf.carrier.cellType.maxTxPw(:,1).' ,cellsPerCarrier,conf.database.numOfLSAChannels,nextTime);
