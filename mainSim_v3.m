...
%                  out = runSnapshotSimulation(conf,carrierArray,cellTypeArray,cls,cellsPerCarrier,carrierTypeArray,numOfCarriers);
        ...
        idx_TX_BS = cellsPerCarrier( conf.general.numOfCarriers,netOperatorEventGen.cell_idx_per_NO(opPerLSAchannel).list) ;
        idx_enabled_BSs = cellsPerCarrier_no_misbehaviour( conf.general.numOfCarriers,netOperatorEventGen.cell_idx_per_NO(opPerLSAchannel).list );
...
%         end
    ...
    %             
        ...
        tmp_v = [tmp_v [nextTime; opPerLSAchannel; isMisbehaving]];
